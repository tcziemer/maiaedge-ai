...
**Lead angle (above the A/B split):** For nearly every Tier 1 and International Backbone target in 2026, the dominant why-now is the AI east-west question - DC-to-DC and cloud-to-cloud reach across operators they partner with, and the revenue waiting on the other side of it. East-west is where the AI networking budget actually sits, and it is the half a carrier building automation in-house cannot reach in time. Lead with that. Track A/B is "how you say it" (the tone and acknowledgment), not "what you say" (the lead). Internal angle-selection trigger (do NOT put figures in cold copy): the category leader publicly sizes its own opportunity as roughly $12B north-south vs roughly $58B east-west and is buying a control plane rather than building it - read that as confirmation that east-west reach + monetize is the question on every board, then write it in segment vocabulary.

Example line (Track A, Tier 1, cold): "Your on-net automation already turns up paths in minutes, and the open question your board is sitting with is the east-west reach across the operators you partner with, since that is the half of the AI networking budget building one in-house cannot reach in time."

**Strategic framing (applies to both tracks):** The "why" for network operators is reach and monetization, with AI east-west reach as the sharpest edge of it. Track A/B determines HOW to position, but the lead angle for both tracks is: "Sell connectivity beyond your footprint. Monetize the infrastructure you already own. Reach the east-west budget you can't build to in time."
...
- **Selling angle:** Their margin is wholesale spread, and that spread is in a structural pincer. Commodity intercity transport pricing is collapsing (internal trigger only, do NOT cite in cold: down ~55% YoY) at the same time hyperscalers now resell capacity back into the same corridors as competitors. Raw-transport margin erodes from both sides; the move is a product/orchestration layer that escapes the price-per-bit race. Position MaiaEdge as inventory that improves their customer-facing fabric without touching their core backbone. "We give your customers a private path on top of your transit; you keep the relationship. They buy fabric experience from us through you." For Tier 1 IP transit sellers: "your wholesale customers want orchestration on top of routes they already get from you; we deliver that without you having to build it." Margin-pincer line (cold): "Selling raw transport into the same corridors the hyperscalers now resell turns every renewal into a price fight, and the wholesale operators getting off that treadmill are the ones putting an orchestration layer their customers buy on top of routes they already run."
...
- **Top anchors:** Seaborn Networks (verified-active independent, primary anchor), BW Digital, Hawaiki Submarine Cable, Telxius (borderline; some terrestrial). Aqua Comms resolved into EXA Infrastructure Dec 31, 2025 (~$46M distressed) - a post-acquisition record routes to EXA / International Backbone Specialist, not this anchor list. Hyperscaler subsea SPVs (Anjana, Cap-1) flag for D1 review whether they're sellable entities.
...
- **Selling angle:** They're being squeezed by hyperscaler subsea builds and need to add fabric-on-top services to defend ARPU. MaiaEdge gives them a programmable terrestrial extension that turns landing-station capacity into instant private fabric for regional carrier customers, without them having to build a terrestrial backbone. **Atlantic-2027 crunch hook (applies to transatlantic-anchored operators here and to International Backbone Specialists):** roughly a third of the Atlantic cables age out by ~2027 (internal trigger: ~7 of 21), so transatlantic wholesale tightens and scarcity becomes pricing power - but only for the operators who can sell that capacity as instantly activatable product. Hook line (cold): "Transatlantic wholesale tightens as a third of the Atlantic cables age out, and the operators that turn that scarce capacity into instantly activatable private paths capture the premium while the ones quoting weeks watch it go to whoever moves first."
...
**US Tier 1s: order automation is real; PATH automation is the gap (re-anchored June 2026):**
- Verizon  -  Partner Solutions publicly markets wholesale APIs (qualification / ordering / status / ticketing); Verizon Business appears on LSO Sonata production-adopter lists; co-marketing enterprise AI with Equinix (June 2026). The old "no public Sonata or wholesale API" claim is stale - do not use it.
- AT&T  -  on Sonata production-adopter lists (ran live API ordering with Colt); Express Waves launched.
- Lumen  -  PCF moved from backlog to P&L: first PCF revenue $78M in Q1 2026 (~$13B cumulative TCV converting), ~2,500 NaaS customers, strategic revenue 51% of business mix. And rather than keep building, Lumen is BUYING the control plane: Alkira, $475M all-cash (announced May 2026, close expected Q3 2026) to unify on-net/off-net/multicloud into one programmable platform.
- **The accurate gap statement:** "The order automates; the path doesn't." Sonata and partner APIs handle inter-carrier quote/order at the top tier; the physical NNI, the cross-connect, and deterministic path activation remain manual. That activation layer is MaiaEdge's ground.
- **Angle for US Tier 1s:** "Proprietary silos are what your competitors are building - and the buy-side price is now public ($475M for a control plane, before integration). Standards-aligned federation is how you avoid rebuilding every carrier integration. MaiaEdge lives above whatever stack you choose  -  ODA-conformant, Mplify LSO-aligned, vendor-neutral."
...
**Standards-body direction as RFP / objection proof (NOT a cold-outreach claim):** The certification bodies are now naming the endgame out loud. Mplify (the ex-MEF standards body) openly describes an "AI federation / AI exchange" future, shipped a Carrier-Ethernet-for-AI certification (Q2 2026), and extended its LSO APIs to internet exchanges (June 4, 2026). Use this only in proposals, RFP responses, and objection handling - "what we're building is aligned with where the certification bodies are heading; the standards body is naming AI federation as the destination, and we're the federation layer that gets you there now." Do NOT put this in cold email or LinkedIn; in cold, the relevance comes from the operator's own problem, not from a standards-body roadmap.
...
### The PCF Benchmark (now a P&L line)
The largest carriers are pivoting hard to AI infrastructure. The most visible example: one major carrier signed ~$13B in private connectivity fabric deals and started RECOGNIZING PCF revenue ($78M in Q1 2026), grew NaaS customers to ~2,500, divested consumer assets to go all-in on enterprise/AI, is tripling its intercity fiber miles, and is buying a multicloud NaaS control plane outright ($475M, May 2026). The board question hardened from "what's our PCF answer?" to "they're recognizing PCF revenue this quarter - where's ours?" Urgency framing cites delivery, not deals. AI long-haul flipped to a supply-constrained boom across the tier (Zayo >$1B AI deals + ~8,000 new route miles; Cogent wavelengths +90.8% YoY; Arelion's named "AI Direct" products): the pain is monetizing scarce inventory fast, not finding demand.

### Hyperscalers Bypassing Carriers
Over two-thirds of global internet traffic already traverses hyperscaler-owned network infrastructure. Hyperscaler capex runs ~$527B in 2026 (top-14 public data-center operators' capex ≈ $750B), overwhelmingly AI-tied, and hyperscalers participate in over two-thirds of planned subsea deployments. Google, Meta, AWS building their own fiber backbones, subsea cables, and edge PoPs. The window for carriers to remain relevant is narrowing - and the subsea cycle flipped to scarcity talk (an Atlantic wholesale capacity crunch projected for late 2027 with 7 of 21 Atlantic cables nearing retirement), which gives wholesale operators pricing power IF they can sell capacity as instantly activatable product.
...
### Autonomous Networking Emerging (and the fabric layer stopped being neutral)
Industry moving toward "Level 4" autonomous networks  -  AI self-optimizing and self-healing. PacketFabric (the merged PacketFabric/Unitas Global entity, Digital Alpha-backed) launched an AI-native NaaS platform with natural-language provisioning. Mplify (formerly MEF) LSO APIs are the standardization framework - in production at the top tier for quote/order, with a certification program standing up precisely because implementation maturity is uneven below it. The 2026 inflection: the fabric players moved up-stack. Megaport raised ~US$594M (A$827M, June 3, 2026) to build a distributed GPU inference cloud across its 1,100+ DCs; for carriers who feed or resell fabrics, "the fabric you send customers to is now a compute company chasing the same enterprise wallet" - the strongest own-your-fabric trigger of the year. Aduna (the Ericsson + 12-operator JV, full US CAMARA coverage Feb 2026) is the existence-proof that operators WILL federate when someone neutral runs the platform - it covers mobile identity/QoD APIs, not transport; the transport equivalent is exactly the open ground MaiaEdge occupies. Full competitive doctrine: `context/core/differentiation-naas-aggregator.md`.
...
| AI east-west budget dwarfs north-south (~$12B N-S vs ~$58B E-W internally; category leader buying a control plane) | The east-west DC-to-DC / cloud-to-cloud reach across partner operators is where the AI networking spend sits, and it's the half in-house automation can't reach in time | "Your on-net automation already turns up paths in minutes. The open east-west question - reach across the operators you partner with - is the half of the AI networking budget you can't build to in time. That's the layer we are." |
| Commodity transport pricing collapsing (~55% YoY internally) + hyperscalers reselling capacity as competitors | Raw-transport margin is pincered from both sides; every renewal is a price fight | "Selling raw transport into corridors the hyperscalers now resell turns every renewal into a price fight. The wholesale operators getting off that treadmill put an orchestration layer their customers buy on top of routes they already run." |
| Atlantic subsea crunch ~2027 (~7 of 21 cables aging out internally) | Transatlantic wholesale tightens into scarcity, but the premium only goes to operators who can sell capacity as instantly activatable product | "Transatlantic capacity tightens as a third of the Atlantic cables age out. The operators that turn scarce capacity into instantly activatable private paths capture the premium; the ones quoting weeks watch it go to whoever moves first." |
| AI-backbone dataplane rebuild via disaggregation (DriveNets; KDDI / AT&T / Comcast deployments) | A disaggregated AI dataplane is fast on-net, but there's still no federation-capable control plane across operators they don't own | "A disaggregated AI backbone gets your dataplane ready. It still doesn't give you a control plane across the operators you don't own - that cross-carrier federation layer is exactly where we sit." |
| Hyperscalers resell capacity back against carriers (not just bypass) | The threat isn't only traffic bypassing the network; it's the hyperscaler underpricing the carrier in the carrier's own corridors | "Hyperscalers aren't just routing around you - they resell your corridors back against you. The defensible move is owning a product layer on top they can't commoditize. Cross-carrier federation is that layer." |
