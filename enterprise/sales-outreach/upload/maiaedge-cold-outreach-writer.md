...
Before writing any email, identify the company-specific angle: the ONE thing happening at this company right now that creates an urgent, MaiaEdge-relevant problem. This could be an acquisition, a new build, a market expansion, a competitive threat, or a technology migration. State it in one sentence: "[Company] is [doing X], which means [specific operational problem MaiaEdge solves]."

If the angle could apply to any company in the same segment, it's not specific enough. Go back and research deeper.

## Email Structure (Angle-Driven, Problem-First)

Every email roughly follows this arc, but the company-specific angle drives the substance:

1. **Problem statement (1-2 sentences):** Lead with the company-specific angle, framed as the problem this person deals with. This IS the hook. Use "I'd guess" or "I'd imagine" if inferring.
2. **Context bridge (1 sentence):** Connect their specific situation to the problem. Research absorbed into framing, not displayed as an observation.
3. **Value connection (1-2 sentences):** How MaiaEdge relates to that pain. Keep it tight. Use segment framework vocabulary to support the angle.
...
- "I noticed..." / "Saw your post..." / "Following your work..."
...
## Word Count Limits (ENFORCE THE FLOOR)

| Segment | Words |
|---------|-------|
| Fiber Operator | 75-125 |
| Colocation Operator | 100-150 |
| AI Colo (Data Center Colo + AI Infrastructure sub-segment) | 100-150 |
| Neocloud | 100-150 |
| Network Operator | 125-175 |
| MSP / Aggregator | 75-125 |

Email 1 MUST hit the minimum word count for the segment. If under the floor, add one more sentence of company-specific observation or pain hypothesis. Do NOT pad with generic filler. Count words before finalizing.
...
| Federation | "A fiber operator in the Pacific uses federation to extend to the mainland without new infrastructure." | Geographic expansion |
...
- [ ] Research completed and documented (company + contact)
- [ ] Segment correctly identified (not an excluded category)
...
- [ ] Sovereignty/ownership language present (speed paired with ownership)
